...
public abstract class SQLCommand
{
    ...
    public static String get_hotel="select uni_type.uni_name,hotel.hotel_type from hotel,uni_type,region,destination where hotel.uni_id=uni_type.uni_id and uni_type.dest_id=destination.dest_id and destination.reg_id=region.reg_id ";
