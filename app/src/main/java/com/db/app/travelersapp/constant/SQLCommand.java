...
public abstract class SQLCommand
{
    ...
    public static String getHotel="select u.uni_id as _id, avg(c.rating) as rating, u.uni_name from hotel h,uni_type u,destination d, cust_rating c where u.dest_id=d.dest_id and u.uni_id=c.uni_id and h.uni_id=u.uni_id and d.dest_name=? GROUP BY u.uni_name,u.uni_id ORDER BY c.rating desc;";
    public static String getRestaurant="select u.uni_id as _id,avg(c.rating) as rating, u.uni_name from restaurant r,uni_type u,destination d,cust_rating c where r.uni_id=u.uni_id and u.uni_id=c.uni_id and u.dest_id=d.dest_id and d.dest_name=? GROUP BY u.uni_name,u.uni_id ORDER BY c.rating desc;";
    public static String getEntertainment="select u.uni_id as _id,avg(c.rating) as rating, u.uni_name from entertainment e,uni_type u,destination d, cust_rating c where e.uni_id=u.uni_id and u.dest_id=d.dest_id and u.uni_id=c.uni_id and d.dest_name=? GROUP BY u.uni_name,u.uni_id ORDER BY c.rating desc;";
